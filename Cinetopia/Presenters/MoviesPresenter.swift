...
//  Cinetopia
//
//  Created by Douglas Silva on 28/02/26.
//
...
protocol MoviesPresenterToViewProtocol: AnyObject {
    ...
    func didSearchTest(_ searchBar: UISearchBar, textDidChange searchText: String, movies: [Movie], _ filteredMovies: inout [Movie])
}
